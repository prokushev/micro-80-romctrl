...
; Не будет работать с:
; * ЮТ-88 С МОНИТОРОМ F (ЖУРНАЛЬНЫЙ ВАРИАНТ) (ошибка в чтении ROM-диска)
; * МИКРО-80 со стандартным МОНИТОРом (нет поддержки ROM-диска)
; ПРОГРАММА УПРАВЛЕНИЯ ЗАФИКСИРОВАНА В ПЗУ ROM-диска.
...
; Формат диска совместим с ROM-диском Орион-128.
; ═══════════════════════════════════════════════════════════════════════

	CPU		8080		; Целевой процессор
	Z80SYNTAX	EXCLUSIVE	; Синтаксис

; ───────────────────────────────────────────────────────────────────────
; Адреса системных вызовов МОНИТОРа
; ───────────────────────────────────────────────────────────────────────
...
;	Проваливаемся в CallReadROM, читаем в ОЗУ и запускаем программу
...
SO1:	DB 	1FH, "*ROM-DISK/32K* V3.0-26"
